...
function Hero() {
  return (
    <div className="w-full min-h-screen h-fit flex justify-center">
      <div className="max-w-screen-xl w-full bg-white flex justify-between items-center">
        <div className="w-[40rem] h-full flex flex-col justify-center items-start">
            <h1 className="font-mono text-6xl font-semibold">Best Place to buy<br/><span className="font-extrabold text-blue-600">Everything</span></h1>
            <p className="font-sans font-light mt-5 w-[28rem]">At Uncanny Store you can shop whatever you think at very accesible prices, so... What do you think, Let's buy something!!</p>

            <button className="bg-blue-600 text-slate-100 p-2 pl-5 pr-5 rounded-md mt-10"> Shopping Now</button>

        </div>
      
        <div className="w-[35rem] relative max-h-screen">
